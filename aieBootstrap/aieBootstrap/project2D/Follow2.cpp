...
Follow2::Follow2() : IBehaviour(1.0f)
{
...
Vector2 Follow2::Update(Agents * agent, float fDeltaTime)
{
	m_path.Clear();
	m_pAStar->CalculatePath(m_pGrid->getNode(158), m_pGrid->getNode(1), &m_path);
